...
namespace Utils
{
    ...
    /// </summary>
    public static class CTWAnchorPrefabSpawnerUtilities
    {
        ...
        /// </remarks>
        public static Vector3 GetPrefabScaleBasedOnAnchorVolume(MRUKAnchor anchorInfo, bool matchAspectRatio,
            ...
            AnchorPrefabSpawner.ScalingMode scaling = AnchorPrefabSpawner.ScalingMode.Stretch)
        {
            ...
            {
                GetDirectionAwayFromClosestWall(anchorInfo, out cardinalAxisIndex);
            }
        ...
        /// </remarks>
        public static Pose GetPoseBasedOnAnchorVolume(MRUKAnchor anchorInfo, Bounds? prefabBounds,
        ...
        /// </remarks>
        public static void MatchAspectRatio(MRUKAnchor anchorInfo, bool calculateFacingDirection, Vector3 prefabSize,
        ...
        public static Vector3 GetDirectionAwayFromClosestWall(MRUKAnchor anchor, out int cardinalAxisIndex, List<int> excludedAxes = null)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                var WallAnchors = MRUK.Instance.GetCurrentRoom().Anchors
                    .Where(anchor => anchor.Label == MRUKAnchor.SceneLabels.WALL_FACE);
        ...
        /// </remarks>
        public static Bounds RotateVolumeBounds(Bounds bounds, int rotation)
        {
        ...
        /// </remarks>
        public static Vector3 GetPrefabScaleBasedOnAnchorPlaneRect(MRUKAnchor anchorInfo, Bounds? prefabBounds,
            AnchorPrefabSpawner.ScalingMode scalingMode = AnchorPrefabSpawner.ScalingMode.Stretch)
        {
        ...
        /// </remarks>
        public static Pose GetPoseBasedOnAnchorPlaneRect(MRUKAnchor anchorInfo,
